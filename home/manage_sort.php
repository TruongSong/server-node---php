...
$ma_danhmuc = $_GET['ma_danh_muc'];
// $sql = "SELECT *  FROM tbl_mohinh  WHERE ma_danhmuc = $ma_danhmuc ORDER BY gia $sort_option ";
// $result = $con->query($sql);
// $array = [];
// include "../general/getdatabase.php";
$data = file_get_contents("http://localhost:3000/mohinhsSort/".$ma_danhmuc.'/?gia='.$sort_option.'');
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-9 p-5">
                ...
                <h4 class="text-center "> Mô Hình Sản Phẩm </h4>
