...
// $sql = "SELECT *  FROM tbl_mohinh WHERE ma_danhmuc =2 ";
// $result = $con->query($sql);
// $array = [];
// include "../general/getdatabase.php";
// print_r($array);

$data = file_get_contents("http://localhost:3000/mohinhs/2");
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-9 p-5">
                <h4 class="text-center"> Mô Hình Sản Phẩm Dragon Ball</h4>
                <form name="kiemtra" action="manage_sort.php" method="GET" onsubmit="return validateform()">
                    <div>
                        ...
                        <input type="hidden" name="ma_danh_muc" value="2">
                    </div>
                </form>
                <div class="row">
                    <?php                       
